...
const OfferContractPolicy = `Every offer — an incident or engineering task offer with its
repository and prompt, the optional task_pull_request beside it, and every memory, preference,
rule, or schedule offer — is a proposal, not an act.
